...
HTTP.post("http://localhost:3000/products.json", :form => { product: product_type, name: product_name, price: product_price, description: product_description, image_url: product_image_url })
